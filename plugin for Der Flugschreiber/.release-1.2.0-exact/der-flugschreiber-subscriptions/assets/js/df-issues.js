        ...
        function requestIssues(page, append) {
            ...
            window.fetch(window.DFIssues.ajaxUrl, {
                ...
                .catch(function (error) {
                    ...
                    if (empty) {
                        empty.hidden = false;
                        empty.textContent = window.DFIssues && window.DFIssues.errorMessage ? window.DFIssues.errorMessage : 'Could not load issues.';
                    }
                })
                .finally(function () {
                    if (requestId === requestSequence) {
        ...
        function requestArticles(page, append) {
            ...
            window.fetch(window.DFIssues.ajaxUrl, {
                ...
                .catch(function (error) {
                    ...
                    if (empty) {
                        empty.hidden = false;
                        empty.textContent = window.DFIssues && window.DFIssues.errorMessage ? window.DFIssues.errorMessage : 'Could not load articles.';
                    }
                })
                .finally(function () {
                    if (requestId === requestSequence) {

...
class DF_Subscriptions_Admin
{
    ...
    public function render_guide_page()
    {
        ...
        <div class="wrap df-guide">
            <h1><?php esc_html_e('Anleitung - Magazin einrichten', 'der-flugschreiber-subscriptions'); ?></h1>
            <p class="df-guide__intro"><?php esc_html_e('Arbeite diese Schritte einmal von oben nach unten ab.', 'der-flugschreiber-subscriptions'); ?></p>

            <div class="df-guide__step">
                <span class="df-guide__num">1</span>
                <h2><?php esc_html_e('Konto-Seite einrichten', 'der-flugschreiber-subscriptions'); ?></h2>
                <p>
                    <?php
                    printf(
                        /* translators: %s: link to create a new WordPress page. */
                        esc_html__('Erstelle eine %s und füge den Block "DF Subscriber Account" ein. Gäste sehen dort die Anmeldung, angemeldete Abonnenten ihr Konto.', 'der-flugschreiber-subscriptions'),
                        '<a href="' . esc_url($new_page) . '">' . esc_html__('neue WordPress-Seite', 'der-flugschreiber-subscriptions') . '</a>'
                    );
                    ?>
                </p>
                <p>
                    ...
                    printf(
                        ...
                        esc_html__('Veröffentliche die Seite und trage ihre URL unter %s als Login-Seite ein. Hinterlege dort außerdem die externe Bezahlseite.', 'der-flugschreiber-subscriptions'),
            ...
            <div class="df-guide__step">
                ...
                <h2><?php esc_html_e('Ausgaben und Artikel erstellen', 'der-flugschreiber-subscriptions'); ?></h2>
                <ul>
                    <li><?php
                        printf(
                            /* translators: %s: link to create a new magazine issue. */
                            esc_html__('Lege unter %s eine Ausgabe an. Wähle den Zugriff, setze Cover, Ausgabennummer und Datum.', 'der-flugschreiber-subscriptions'),
                            '<a href="' . esc_url($new_magazine) . '">' . esc_html__('Ausgaben → Neu', 'der-flugschreiber-subscriptions') . '</a>'
                        );
                    ?></li>
                    <li><?php
                        printf(
                            /* translators: %s: link to create a new article. */
                            esc_html__('Lege unter %s einen Artikel an und verknüpfe ihn mit seiner Ausgabe.', 'der-flugschreiber-subscriptions'),
                            '<a href="' . esc_url($new_article) . '">' . esc_html__('Artikel → Neu', 'der-flugschreiber-subscriptions') . '</a>'
                        );
                    ?></li>
                </ul>
            </div>
            ...
            <div class="df-guide__step">
                ...
                <h2><?php esc_html_e('Abonnenten anlegen', 'der-flugschreiber-subscriptions'); ?></h2>
                <p>
                    <?php
                    printf(
                        /* translators: %s: link to the main plugin screen. */
                        esc_html__('Erstelle Abonnenten unter %s mit E-Mail, Passwort und Ablaufdatum oder importiere sie als CSV.', 'der-flugschreiber-subscriptions'),
                        '<a href="' . esc_url($settings_url) . '">' . esc_html__('DF Subscriptions', 'der-flugschreiber-subscriptions') . '</a>'
                    );
                    ?>
                </p>
            </div>
            ...
            <div class="df-guide__step">
                ...
                <h2><?php esc_html_e('Texte anpassen und testen', 'der-flugschreiber-subscriptions'); ?></h2>
                <ul>
                    <li><?php
                        printf(
                            /* translators: %s: link to the website texts screen. */
                            esc_html__('Alle sichtbaren Überschriften, Buttons und Hinweise änderst du unter %s.', 'der-flugschreiber-subscriptions'),
                            '<a href="' . esc_url($texts_url) . '">' . esc_html__('Inhalte', 'der-flugschreiber-subscriptions') . '</a>'
                        );
                    ?></li>
                    <li><?php esc_html_e('Teste die Konto-Seite einmal abgemeldet und einmal mit einem Abonnenten-Konto.', 'der-flugschreiber-subscriptions'); ?></li>
                </ul>
            </div>
            ...
            <div class="df-guide__note">
                ...
                <ul style="margin:6px 0 0;">
                    ...
                    <li style="list-style:disc;margin-left:18px;"><?php esc_html_e('Für automatische E-Mails muss WordPress-Cron laufen.', 'der-flugschreiber-subscriptions'); ?></li>
                    <li style="list-style:disc;margin-left:18px;"><?php esc_html_e('Bezahlte Ausgaben verwenden den geschützten PDF-Upload.', 'der-flugschreiber-subscriptions'); ?></li>
                </ul>
            </div>
        </div>
        <?php
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php esc_html_e('Enter the URL of the subscriber account page. Guests will use the same page to log in.', 'der-flugschreiber-subscriptions'); ?></p>
                        </td>
                    </tr>
                    <tr>

...
final class DF_Subscriptions
{
    ...
    private function should_enqueue_assets()
    {
        ...
        foreach (array('df_logout_link', 'df_account', 'df_all_issues', 'df_all_articles', 'df_article_page', 'df_homepage', 'df_magazine_archive', 'df_article_archive', 'df_magazine_page', 'df_all_posts', 'df_post_page', 'df_blog_archive') as $shortcode) {

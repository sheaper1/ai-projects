...
class DF_Subscriptions_Account
{
    ...
    public function account()
    {
        ...
        <section class="df-subscriptions-account">
            ...
            <p><a href="<?php echo esc_url(add_query_arg('df_action', 'lostpassword', $this->get_current_url())); ?>"><?php esc_html_e('Change password', 'der-flugschreiber-subscriptions'); ?></a></p>
            <p><?php echo $this->shortcodes->logout_link(array('redirect' => $this->get_current_url())); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
        </section>
        <?php

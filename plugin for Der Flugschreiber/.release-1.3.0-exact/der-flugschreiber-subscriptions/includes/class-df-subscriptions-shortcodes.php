...
class DF_Subscriptions_Shortcodes
{
    ...
    public function magazine_archive($atts)
    {
        ...
        <div class="df-collection-page df-collection-page--issues">
            <header class="df-collection-page__hero">
                <p class="df-collection-page__eyebrow"><?php esc_html_e('Der Flugschreiber', 'der-flugschreiber-subscriptions'); ?></p>
    ...
    public function article_archive($atts)
    {
        ...
        <div class="df-collection-page df-collection-page--articles">
            <header class="df-collection-page__hero">
                <p class="df-collection-page__eyebrow"><?php esc_html_e('Aus dem Magazin', 'der-flugschreiber-subscriptions'); ?></p>
                <h1><?php echo esc_html($atts['title']); ?></h1>
                <p><?php echo esc_html($atts['intro']); ?></p>
            </header>
            <?php
    ...
    public function magazine_page($atts)
    {
        ...
        <article class="df-magazine-page">
                ...
                <div class="df-magazine-page__hero-grid">
                    ...
                    <div class="df-magazine-page__heading">
                        ...
                        <div class="df-magazine-page__actions">
                            <?php if ($pdf_url) : ?>
                                <a class="df-magazine-page__button df-magazine-page__button--primary" href="<?php echo esc_url($pdf_url); ?>" target="_blank" rel="noopener"><?php esc_html_e('PDF öffnen', 'der-flugschreiber-subscriptions'); ?></a>
                            <?php elseif (!$can_read && $payment_url) : ?>
                                <a class="df-magazine-page__button df-magazine-page__button--primary" href="<?php echo esc_url($payment_url); ?>"><?php esc_html_e('Jetzt abonnieren', 'der-flugschreiber-subscriptions'); ?></a>
                            <?php endif; ?>
                            <?php if (!$can_read) : ?>
                                <a class="df-magazine-page__button" href="<?php echo esc_url($login_url); ?>"><?php esc_html_e('Einloggen', 'der-flugschreiber-subscriptions'); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            <?php if (!empty($articles)) : ?>
                <section class="df-magazine-page__articles">
                    <div class="df-magazine-page__section-heading">
                        <p><?php esc_html_e('In dieser Ausgabe', 'der-flugschreiber-subscriptions'); ?></p>
                        <h2><?php echo esc_html($atts['articles_title']); ?></h2>
                    </div>
                    <div class="df-magazine-page__article-grid">
                        <?php foreach ($articles as $article) : ?>
                            <?php $image = $this->get_article_image_url($article, $magazine->ID); ?>
                            <article>
                                <a class="df-magazine-page__article-image" href="<?php echo esc_url(get_permalink($article)); ?>">
                                    <?php if ($image) : ?>
                                        <img src="<?php echo esc_url($image); ?>" alt="<?php echo esc_attr(get_the_title($article)); ?>" loading="lazy">
                                    <?php else : ?>
                                        <span><img src="<?php echo esc_url(DF_SUBSCRIPTIONS_PLANE_ALT_URL); ?>" alt="" aria-hidden="true"></span>
                                    <?php endif; ?>
                                </a>
                                <h3><a href="<?php echo esc_url(get_permalink($article)); ?>"><?php echo esc_html(get_the_title($article)); ?></a></h3>
                                <a class="df-magazine-page__article-link" href="<?php echo esc_url(get_permalink($article)); ?>"><?php esc_html_e('Artikel lesen', 'der-flugschreiber-subscriptions'); ?></a>
                            </article>
                        <?php endforeach; ?>
                    </div>
                </section>
    ...
    {
        $fallback = __('Die Ausgabe verbindet fundierte Fachthemen mit persönlichen Reportagen, starken Bildern und Erfahrungen aus der fliegerischen Praxis.', 'der-flugschreiber-subscriptions');

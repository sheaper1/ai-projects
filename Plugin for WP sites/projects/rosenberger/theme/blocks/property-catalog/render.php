<?php
/**
 * Property Catalog — серверный рендер.
 *
...
// Термины для выпадающих списков
...
<section <?php echo $wrapper_attrs; ?>>
	<div class="pc-inner">
		...
		<header class="pc-header">
			<h2 class="pc-heading">Aktuelle Objekte <em>in Vorarlberg</em></h2>
			<p class="pc-subtext">Sie suchen ein Zuhause oder ein Grundstück in Vorarlberg? Hier sehen Sie, was ich gerade vermittle. Der Bestand wird laufend aktualisiert.</p>
		</header>

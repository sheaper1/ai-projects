...
| Split CTA | `library/split-cta` | Две колонки: текст (заголовок + абзацы + кнопка) слева, изображение справа. На мобилке фото сверху. | split, cta, текст, изображение, две колонки | stable |

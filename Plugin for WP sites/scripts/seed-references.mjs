...
const SAMPLES = [
	...
	{
		title: 'Doppelhaushälfte mit Terrasse in Dornbirn',
		excerpt: 'Moderne Doppelhaushälfte mit sonniger Terrasse und Carport in familienfreundlicher Lage. Zügig und zum Bestpreis vermittelt.',
		type: 'Haus', city: 'Dornbirn', featured: 'property/gallery/img-1.webp', galleryFiles: [ 'property/gallery/img-1.webp', 'property/gallery/img-3.webp', 'cards/card-2.jpg' ],
		meta: {
			property_object_type: 'Doppelhaushälfte', property_status: 'Verkauft',
			property_address: 'Dornbirn · Vorarlberg, Österreich',
			property_price: '595.000 €', property_price_sub: 'zzgl. Kaufnebenkosten',
			property_area: '165 m²', property_rooms: '5', property_bedrooms: '3',
			property_bathrooms: '2', property_floor: '—', property_year: '2015',
			property_plot_area: 'ca. 380 m²',
		},
		ref: { reference_quote: 'Vom ersten Gespräch bis zur Übergabe lief alles reibungslos. Sehr zu empfehlen!', reference_author: 'Markus T.', reference_location: 'Dornbirn', reference_rating: '5' },
	},
	{
		title: 'Geräumige 2-Zimmer-Wohnung in Feldkirch',
		excerpt: 'Helle Zwei-Zimmer-Wohnung mit Balkon und Tiefgaragenplatz in zentraler Lage. Schnell vermittelt.',
		type: 'Wohnung', city: 'Feldkirch', featured: 'property/gallery/img-2.webp', galleryFiles: [ 'property/gallery/img-2.webp', 'property/gallery/hero.webp' ],
		meta: {
			property_object_type: 'Eigentumswohnung', property_status: 'Verkauft',
			property_address: 'Feldkirch · Vorarlberg, Österreich',
			property_price: '395.000 €', property_price_sub: '5.064 €/m² · zzgl. Kaufnebenkosten',
			property_area: '78 m²', property_rooms: '2', property_bedrooms: '1',
			property_bathrooms: '1', property_floor: '1. OG', property_year: '2016',
			property_plot_area: '—',
		},
		ref: { reference_quote: 'Schnelle Abwicklung und faire Beratung. Wir sind rundum zufrieden.', reference_author: 'Sandra P.', reference_location: 'Feldkirch', reference_rating: '5' },
	},
	{
		title: 'Großzügiges Baugrundstück in Bregenz',
		excerpt: 'Sonniges, voll erschlossenes Baugrundstück in begehrter Aussichtslage. Diskret vermittelt.',
		type: 'Grundstück', city: 'Bregenz', featured: 'property/gallery/img-3.webp', galleryFiles: [ 'property/gallery/img-3.webp', 'cards/card-1.jpg' ],
		meta: {
			property_object_type: 'Baugrundstück', property_status: 'Verkauft',
			property_address: 'Bregenz · Vorarlberg, Österreich',
			property_price: '480.000 €', property_price_sub: 'zzgl. Kaufnebenkosten',
			property_area: '', property_rooms: '', property_bedrooms: '',
			property_bathrooms: '', property_floor: '', property_year: '',
			property_plot_area: 'ca. 920 m²',
		},
		ref: { reference_quote: 'Kompetente Begleitung über den gesamten Verkaufsprozess. Sehr empfehlenswert.', reference_author: 'Thomas R.', reference_location: 'Bregenz', reference_rating: '5' },
	},
	{
		title: 'Büro- und Geschäftsfläche in Dornbirn',
		excerpt: 'Repräsentative Gewerbefläche mit Schaufensterfront in Top-Lage. Erfolgreich an einen langfristigen Mieter vermittelt.',
		type: 'Gewerbe', city: 'Dornbirn', featured: 'cards/card-2.jpg', galleryFiles: [ 'cards/card-2.jpg', 'property/gallery/img-1.webp', 'property/gallery/img-2.webp' ],
		meta: {
			property_object_type: 'Gewerbeobjekt', property_status: 'Vermietet',
			property_address: 'Dornbirn · Vorarlberg, Österreich',
			property_price: 'Auf Anfrage', property_price_sub: '',
			property_area: '240 m²', property_rooms: '', property_bedrooms: '',
			property_bathrooms: '2', property_floor: 'EG', property_year: '2012',
			property_plot_area: '—',
		},
		ref: { reference_quote: 'Professionelle Vermarktung unserer Gewerbefläche – schnell den passenden Mieter gefunden.', reference_author: 'GF Lechner GmbH', reference_location: 'Dornbirn', reference_rating: '5' },
	},
	{
		title: 'Gewerbehalle mit Lagerfläche in Bludenz',
		excerpt: 'Vielseitig nutzbare Gewerbehalle mit großzügiger Lager- und Produktionsfläche. Erfolgreich verkauft.',
		type: 'Gewerbe', city: 'Bludenz', featured: 'cards/card-3.jpg', galleryFiles: [ 'cards/card-3.jpg', 'property/gallery/hero.webp', 'property/gallery/img-3.webp' ],
		meta: {
			property_object_type: 'Gewerbeobjekt', property_status: 'Verkauft',
			property_address: 'Bludenz · Vorarlberg, Österreich',
			property_price: '1.150.000 €', property_price_sub: 'zzgl. Kaufnebenkosten',
			property_area: '620 m²', property_rooms: '', property_bedrooms: '',
			property_bathrooms: '1', property_floor: 'EG', property_year: '2009',
			property_plot_area: 'ca. 1.400 m²',
		},
		ref: { reference_quote: 'Von der Bewertung bis zum Abschluss alles aus einer Hand. Klare Empfehlung für Gewerbeimmobilien.', reference_author: 'Familie B.', reference_location: 'Bludenz', reference_rating: '5' },
	},
	{
		title: 'Penthouse-Wohnung mit Dachterrasse in Bregenz',
		excerpt: 'Exklusive Penthouse-Wohnung mit umlaufender Dachterrasse und Seeblick. Diskret und erfolgreich vermittelt.',
		type: 'Wohnung', city: 'Bregenz', featured: 'property/gallery/hero.webp', galleryFiles: [ 'property/gallery/hero.webp', 'property/gallery/img-1.webp', 'property/gallery/img-3.webp' ],
		meta: {
			property_object_type: 'Eigentumswohnung', property_status: 'Verkauft',
			property_address: 'Bregenz · Vorarlberg, Österreich',
			property_price: '890.000 €', property_price_sub: '6.357 €/m² · zzgl. Kaufnebenkosten',
			property_area: '140 m²', property_rooms: '4', property_bedrooms: '3',
			property_bathrooms: '2', property_floor: '4. OG', property_year: '2020',
			property_plot_area: '—',
		},
		ref: { reference_quote: 'Diskrete und hochprofessionelle Vermittlung unseres Penthouses. Wir fühlten uns bestens beraten.', reference_author: 'Dr. H. Wagner', reference_location: 'Bregenz', reference_rating: '5' },
	},
];
